...
public class EquipmentServiceImpl implements EquipmentService{
    ...
    public EquipmentDTO createEquipment(EquipmentDTO equipmentDTO) {
        User renter = userRepository.findById(equipmentDTO.getRenterID())
                .orElseThrow(() -> new ResourceNotFoundException("Renter not found with id " + equipmentDTO.getRenterID()));
    ...
    public EquipmentDTO getEquipmentById(Integer equipmentId) {
        Equipment equipment = equipmentRepository.findById(equipmentId)
                .orElseThrow(() -> new ResourceNotFoundException("Equipment not found with id " + equipmentId));
        return new EquipmentDTO(equipment.getEquipmentID(), equipment.getRenter().getId(), equipment.getEquipmentName(),
